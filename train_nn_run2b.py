...
for ep in range(EPOCHS):
    ...
    if a>best:
        ...
        torch.save(best_state,"nn2_state.pt")   # resilience: weights on disk each improvement
    else:
        bad+=1
...
tpred=predict(net,Xte,Mte); np.save("test_nn2.npy",tpred)
